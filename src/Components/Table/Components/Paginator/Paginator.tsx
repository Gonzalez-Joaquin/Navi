...
const Paginator = ({ currentPage, totalPages, exactPage, nextPage, prevPage }: Props) => {
        ...
        <tr className={style.row}>
          <td className={style.cell}>
            ...
            <div className={style.buttonsContainer}>
              <button onClick={prevPage} type="button" id="table-foot-row-cell-button-prevButton">
              ...
              <button onClick={nextPage} id="table-foot-row-cell-button-nextButton">
                <svg width="9" height="17" viewBox="0 0 9 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
